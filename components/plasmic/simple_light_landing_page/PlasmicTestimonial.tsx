...
import Avatar from "../../Avatar"; // plasmic-import: EfGYwRw9pSRN-n/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: QCuEfYzwNMVk1T/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: JMBKj7akn61UnJ/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__h58Aa)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__mvxN9)}
        >
          <div
            className={classNames(
              projectcss.all,
