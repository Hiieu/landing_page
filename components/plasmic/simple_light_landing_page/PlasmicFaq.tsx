...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: KQPbTxv5Ryq_jN/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__gyf4)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__t5P7S)}>
          <div className={classNames(projectcss.all, sty.freeBox__aivus)}>
            {p.renderPlasmicSlot({
