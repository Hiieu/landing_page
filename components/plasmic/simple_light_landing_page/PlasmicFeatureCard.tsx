...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: IAj06pVnio3t_/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__zh51F, {
            [sty.freeBoxlong__zh51F3LwaP]: hasVariant($state, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__uAa9V, {
              [sty.freeBoxlong__uAa9V3LwaP]: hasVariant($state, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg__tq2Km)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__oNWt3, {
          [sty.freeBoxlong__oNWt33LwaP]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__egqsj, {
            [sty.freeBoxlong__egqsj3LwaP]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___4OQv1)}
                role={"img"}
              />
            ),
