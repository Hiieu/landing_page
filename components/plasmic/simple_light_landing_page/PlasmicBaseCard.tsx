...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: uW2IvJsOpicilR/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__h3Gz9, {
          [sty.freeBoxlong__h3Gz9OwZ]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__pjxIk, {
            [sty.freeBoxlong__pjxIkOwZ]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__yKvdk)}
                role={"img"}
              />
            ),
